      ...
      <div id="content">
       ...
       <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Coordinator / Team Leader</h6>
            </div>
            <div class="card-body">
                <form action='<?php echo base_url(); ?>admin/user/teamLead' onsubmit="return validateForm()" method='post'>
                <div class="row date_body">
                                ...
                                <?php 
                                    if(isset($resp)){
                                        foreach ($resp as $key => $value) {
                                            echo "<option value='$value->coordinator_id'>$value->coordinator_name</option>";
                                        }
                                    }
                                ?>
                                </select>
                        ...
                        <div class="col-md-2 start_date form-group" style="text-align:right">
                            <input type="submit" id="submit" value="ASSIGN TEAM LEADER" name="submit"class="btn btn-success" >
                        </div>
                </div>
                </form>
            </div>
           <div class="card-header py-3" style="border-top:1px solid #e3e6f0;">
              <h6 class="m-0 font-weight-bold text-primary">Assigned Team Leader's Employee List</h6>
            </div>
            <div class="card-body">
                <div class="row date_body">
              <div class="table-responsive" id="dataTable1">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody id="dataTable1">
                         <?php 
                          if(isset($assigned_emp_list)){
                              $sn = 1;
                              foreach ($assigned_emp_list as $key => $value) {
                                  echo "<tr>";
                                  echo "<td>$sn</td>";
                                  echo "<td>$value->emp_name</td>";
                                  echo "<td>$value->coordinator_name</td>";
                                  echo "<td>$value->emp_mobile</td>";
                                  echo "<td><a href='".base_url()."index.php/admin/user/employee_details/$value->emp_id' target='_blank'>View Details</a></td>";
                                  echo "</tr>";
                                  $sn = $sn+1;
                              }
                          }else{

<!DOCTYPE html><?php include_once 'files/session.php'; ?>
<head>
				...
				<!--notification start-->
					...
					<div class="notify-w3ls">
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="<?php echo base_url();?>#">Jonathan Smith</a></span> send you a mail </li>
						...
						<div class="alert alert-danger">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="<?php echo base_url();?>#">Jonathan Smith</a></span> mentioned you in a post </li>
						...
						<div class="alert alert-success ">
							...
							<div class="notification-info">
								...
								<p>
									<a href="<?php echo base_url();?>#">Anjelina Mewlo, Jack Flip</a> and <a href="<?php echo base_url();?>#">3 others</a>
								</p>
							</div>
						</div>

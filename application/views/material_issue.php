      ...
      <div id="content">
       ...
       <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Material Issue</h6>
            </div>
            <div class="card-body">
                <form action='<?php echo base_url(); ?>admin/user/material_issue' method='post'>
                <div class="row date_body">
						...
						?>
                            ...
                            <div class="col-md-6">
                            	<input type="text" id="issue_date" name="issue_date" class="form-control" placeholder="Select Date" required>
                            </div>
                        <div class="col-md-12 mt-2 text-center" style="text-align:right">
                            <input type="submit" id="submit" value="ISSUE" name=""class="btn btn-success" >
                        </div>
                </div>
                </form>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive" id="dataTable1">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody id="dataTable1">
                         <?php 
                          if(isset($material_issue_list)){
                              $sn = 1;
                              foreach ($material_issue_list as $key => $value) {
                                  echo "<tr>";
                                  echo "<td>$sn</td>";

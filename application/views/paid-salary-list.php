...
<head>
  ...
  <title>ETI Office Management - Team Lead</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action='<?php echo base_url(); ?>admin/user/paidSalaryList' onsubmit="return validateForm()" method='post'>
                <div class="row date_body">
                                ...
                                <?php 
                                    if(isset($emp_list)){
                                        foreach ($emp_list as $key => $value) {
                                            echo "<option value='$value->emp_id'>$value->emp_id ($value->emp_name)</option>";
                                        }
                                    }
                                ?>
                                </select>
                        ...
                        <div class="col-md-4 start_date form-group" style="text-align:right">
                            <input type="submit" id="submit" value="GET SALARY LIST" name="submit"class="btn btn-success" >
                        </div>
                </div>
                </form>
            </div>
           <div class="card-header py-3" style="border-top:1px solid #e3e6f0;">
              <h6 class="m-0 font-weight-bold text-primary">Month Wise Employee List</h6>
            </div>
            <div class="card-body">
                <div class="row date_body">
                         ...
                         <?php 
                            if(isset($resp)){
                              ...
                              foreach ($resp as $key => $value) {
                                  ...
                                  echo "<td>$value->woc</td>";
                                  echo "<td>$value->total_present</td>";
                                  echo "<td>$value->total_absent</td>";
                                  echo "<td>$value->monthly_salary_amount</td>";
                                  echo "<td>$value->total_salary</td>";
                                  echo "<td>$value->salary_status</td>";
                                  echo "<td>$value->hr_comments</td>";
                                  echo "</tr>";
                                  $sn = $sn+1;
                              }
                          }else if(isset($resp2)){
                                $sn = 1;
                                  ...
                                  echo "<td>".$sn."</td>";
                                  echo "<td>$month - $year</td>";
                                  echo "<td>".$resp2[0]->emp_name."</td>";
                                  echo "<td>".$resp2[0]->woc."</td>";
                                  echo "<td>".$resp2[0]->total_present."</td>";
                                  echo "<td>".$resp2[0]->total_absent."</td>";
                                  echo "<td>".$resp2[0]->monthly_salary_amount."</td>";
                                  echo "<td>".$resp2[0]->total_salary."</td>";
                                  echo "<td>".$resp2[0]->salary_status."</td>";
                                  echo "<td>".$resp2[0]->hr_comments."</td>";
                                  echo "</tr>";
                                  $sn = $sn+1;
                          }else{

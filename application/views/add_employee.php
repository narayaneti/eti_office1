       ...
       <div class="card shadow mb-4">
            ...
            <div class="row date_body">
            	<div class="col-sm-6 start_date form-group">
                    ...
                    <input type="text" value="" name="name" placeholder="Employee Name" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Mobile</label>
                    <input type="text" value="" name="mobile" placeholder="Employee Mobile No" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Email Id</label>
                    <input type="email" value="" name="email" placeholder="Employee Email Id" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Employee Id</label>
                    <input type="text" value="" name="employee_id" placeholder="Employee Id" id="site_name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Password</label>
                    <input type="text" value="" name="password" placeholder="Password" id="site_name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    ...
                    <select name="technology_id" placeholder="Designation" id="technology_id" class="form-control" required="">
                        ...
                        if(isset($technology_resp)){
                            ...
                            foreach ($technology_resp as $key => $value) {
                                echo "<option value='$value->technology_id'>$value->technology</option>";
                            }
                        }
                        ?>
                    </select>
                ...
                <div class="col-sm-6 start_date form-group">
                    ...
                    <input type="date" value="" name="joining_date" placeholder="Site Id" id="joining_date" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Training Days</label>
                    <input type="text" value="" name="training_days" placeholder="Training Days" id="training_days" class="form-control">
                </div>
                </div>
            </div>
            ...
            <div class="row date_body">
                <div class="col-sm-6 start_date form-group">
                    ...
                    <input type="text" value="" name="bank_name" placeholder="Bank Name" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">IFSC Codes</label>
                    <input type="text" value="" name="ifsc" placeholder="IFSC Codes" id="name" class="form-control" required="">
                </div>
            	<div class="col-sm-6 start_date form-group">
                    <label for="start_date">Account Holder Name</label>
                    <input type="text" value="" name="account_holder" placeholder="Account Holder Name" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Account No</label>
                    <input type="text" value="" name="account_number" placeholder="Account No" id="name" class="form-control" required="">
                </div>
            </div>
            </div>
            <div class="card-header py-3" style="border-top: 1px solid #e3e6f0;">
            ...
            <div class="row date_body">
                <div class="col-sm-6 start_date form-group">
                    ...
                    <input type="number" value="" name="gross_salary" placeholder="Gross Salary" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Net Salary</label>
                    <input type="number" value="" name="net_salary" placeholder="Net Salary" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Provident Fund</label>
                    <input type="number" value="" name="pf" placeholder="Provident Fund" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">ESIC</label>
                    <input type="number" value="" name="esic" placeholder="ESIC" id="name" class="form-control" required="">
                </div>
            	<div class="col-sm-6 start_date form-group">
                    <label for="start_date">Other</label>
                    <input type="number" value="" name="other" placeholder="Other" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Tax</label>
                    <input type="number" value="" name="tax" placeholder="Tax" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Insurance</label>
                    <input type="text" value="" name="insurance" placeholder="Insurance" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Travelling Allowance</label>
                    <input type="number" value="" name="ta" placeholder="Travelling Allowance" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Dearness Allowance</label>
                    <input type="number" value="" name="da" placeholder="Dearness Allowance" id="name" class="form-control" required="">
                </div>
           ...
           <div class="card-body">
            <div class="row date_body">
            	<div class="col-sm-6 start_date form-group">
                    ...
                    <input type="date" value="" name="dob" placeholder="Employee DOB" id="dob" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Employee Blood Group</label>
                    <input type="text" value="" name="blood_group" placeholder="Employee Blood Group" id="blood_group" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Father's Name</label>
                    <input type="text" value="" name="fname" placeholder="Employee Father's Name" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Mother's Name</label>
                    <input type="text" value="" name="mname" placeholder="Employee Mother's Name" id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Highest Qualification</label>
                    <input type="text" value="" name="qualification" placeholder="Highest Qualification" id="dob" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Family Contact No</label>
                    <input type="text" value="" name="family_contact" placeholder="Employee Family Contact No" id="blood_group" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Current Address</label>
                    <input type="text" value="" name="current_address" placeholder="HN, Colony, Street, Landmark (Full Address) " id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Current City</label>
                    <input type="text" value="" name="current_city" placeholder="Current City" id="current_city" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Current State</label>
                    <input type="text" value="" name="current_state" placeholder="Current State" id="site_name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Permanent Address</label>
                    <input type="text" value="" name="permanent_address" placeholder="HN, Colony, Street, Landmark (Full Address) " id="name" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Permanent City</label>
                    <input type="text" value="" name="permanent_city" placeholder="Permanent City" id="current_city" class="form-control" required="">
                </div>
                <div class="col-sm-6 start_date form-group">
                    <label for="start_date">Permanent State</label>
                    <input type="text" value="" name="permanent_state" placeholder="Permanent State" id="site_name" class="form-control" required="">
                </div>
               </div>
               <button  type="submit" name="submit" id="submit" class="btn btn-success" style="margin-bottom:10px;">Submit</a>
...
$(document).ready(function() {
     $("#submit").on("click", function() {
                var frmstatus = 1;
                var aurl = "<?php echo base_url(); ?>index.php/admin/User/register_employee";
                var designation_id = $("#designation_id option:selected").val();
                ...
                if(technology_id == "" || technology_id == null){
                    frmstatus = 0;
                ...
                var dataString1 = 'name1='+ name + '&mobile=' + mobile + '&email=' + email + '&employee_id=' + employee_id + '&password=' + password + '&joining_date='+ joining_date + '&training_days='+ training_days + '&bank_name='+ bank_name + '&designation_id=' + designation_id;

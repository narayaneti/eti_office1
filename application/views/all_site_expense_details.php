...
<head>
  ...
  <title>SB Admin 2 - Site Survey Expense Details</title>
                ...
                <div class="table-responsive" style="width:100%;">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th>Status By PM</th>
                      <th>Status By Accou</th>
                      <th>Comment By Coordi</th>
                      <th>Comment By PM</th>
                      <th>Coord. Date</th>
                      <th>MP. Date</th>
                      <th>Acco. Date</th>
                       ...
                       <?php 
                        if(isset($exp_resp)){
                            ...
                            foreach ($exp_resp as $key => $value) {
                                ...
                                echo "<td><input type='number' value='$value->paid_amount' class='form-control' name='expense_by_coordinator[]' required readonly/></td>";
                                echo "<td><input type='text' value='$value->expense_status_by_coordinator' class='form-control' name='expense_status_by_coordinator[]' required readonly/></td>";
                                echo "<td><input type='text' value='$value->expense_approved_by_project_manager' class='form-control' name='expense_approved_by_project_manager[]' required readonly/></td>";
                                echo "<td><input type='text' value='$value->paid_amount_status_by_accountant' class='form-control' name='paid_amount_status_by_accountant[]' required readonly/></td>";
                                echo "<td><input type='text' value='$value->coordinator_comment' class='form-control' name='coordinator_comment[]' required readonly/></td>";
                                echo "<td><input type='text' value='$value->project_manager_comment' class='form-control' name='project_manager_comment[]' readonly/></td>";
                                echo "<td><input type='text' value='$value->coordinator_updated_date' class='form-control' name='paid_amount_status_by_accountant[]' readonly/></td>";
                                echo "<td><input type='text' value='$value->project_manager_updated_date' class='form-control' name='paid_amount_status_by_accountant[]' readonly/></td>";
                                echo "<td><input type='text' value='$value->accountant_updated_date' class='form-control' name='paid_amount_status_by_accountant[]' readonly/></td>";
                                echo "</tr>";
                                $sn = $sn+1;
                            }
                        }else{

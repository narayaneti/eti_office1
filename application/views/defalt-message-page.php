       ...
       <div class="card shadow mb-4">
            ...
            <div class="row date_body">
            	<?php 
                    ...
                    if(isset($message)){
                        echo "<h1 style='text-align:center; font-size:18px; margin:100px 0; padding:30px; width:100%;'>".$message."</h1>"; 
                        echo "<a href='".base_url()."admin/user/dashboard'>Go To Dashboard</a>";
                    }
                ?>
            </div>
          </div>

      ...
      <div id="content">
       ...
       <div class="card shadow mb-4">
            ...
            <div class="row date_body">
                ...
                <form action='<?php echo base_url(); ?>admin/user/approved_expense_by_project_manager' onsubmit="return validateForm()" method='post'>
              <div class="table-responsive">
                             ...
                             <?php 
                              if(isset($exp_resp)){
                                  ...
                                  foreach ($exp_resp as $key => $value) {
                                      ...
                                      echo "<td><input type='text' value='$value->expense_status_by_coordinator' class='form-control' name='coordinator_comment[]' required readonly></td>";
                                      ...
                                      echo "<td><input type='text' value='$value->project_manager_comment' class='form-control' name='project_manager_comment[]' required/></td>";
                                      echo "</tr>";
                                      $sn = $sn+1;
                                  }
                              }else{
                    ...
                    <div class="row">
                      <div class="col-md-4">
                          <select name='expense_approved_by_project_manager' class='form-control' required/><option value=''> Select Expense Status By Project Managed </option><option value='Pending'>Pending</option><option value='Approved'>Approved</option></select>
                      </div>
                      <div class="col-md-4">
                          ...
                          <input type="submit" name="submit" value="Submit Approved / Peanding Staus By Project Managed" class="btn btn-info" />
                      </div>
                      </div> 
            </form>
            </div>

...
echo "</div>";
?>
        <form action="<?php echo base_url();?>index.php/admin/user/login_process" method="post" enctype="">
			<input type="text" class="ggg" name="mobile" placeholder="Mobile No" required="">
			<input type="password" class="ggg" name="password" placeholder="Password" required="">
			<span><input type="checkbox" />Remember Me</span>
			<h6><a href="<?php echo base_url();?>#">Forgot Password?</a></h6>
				<div class="clearfix"></div>
				<input type="submit" value="Sign In" name="login">
		</form>
		<p>Don't Have an Account ?<a href="<?php echo base_url();?>registration.html">Create an account</a></p>
</div>
</div>

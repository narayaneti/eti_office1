...
<head>
  ...
  <title>SB Admin 2 - All Expense List</title>
                       ...
                       <?php 
                        if(isset($resp)){
                            ...
                            foreach ($resp as $key => $value) {
                                ...
                                echo "<td>$value->coordinator</td>";
                                echo "<td>$value->accounting_head</td>";
                                echo "<td>$value->location</td>";
                                echo "<td>$value->debit_amount</td>";
                                echo "<td>$value->description</td>";
                                echo "<td>$value->remark</td>";
                                echo "<td>$value->payment_date</td>";
                                echo "<td>$value->paid_by</td>";
                                echo "</tr>";
                                $sn = $sn+1;
                            }
                        }else{
